...
mapf_environment::Observation Environment::get_observation(int agent) {
	...
	if (done) {
		...
		if (collisions[agent]) obs.reward += collision_reward;
		obs.done = false;
	}
